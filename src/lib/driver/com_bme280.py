...
class BME280:
    def __init__(self, busnumber, i2caddr):
        self.bus_number = busnumber  # 1
        self.i2c_address = i2caddr  # 0x76
    ...
    def compensate_h(self, adc_h):
        ...
        if var_h != 0:
            ...
            return 0
        var_h *= 1.0 - self.digH[0] * var_h / 524288.0
        if var_h > 100.0:
            var_h = 100.0
        elif var_h < 0.0:
            var_h = 0.0
    ...
    def setup(self):
        ...
        config_reg = (t_sb << 5) | (fltr << 2) | spi3w_en
        ctrl_hum_reg = osrs_h
