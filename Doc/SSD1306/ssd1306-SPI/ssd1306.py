...
class SSD1306:
    ...
    def hardware(self, multiplex = 63, display_offset = 0, start_line = 0, remap_segment = False, remap_scan_direction = False, remap_leftright = False,
                 alternative_com_pin = False):
        """
